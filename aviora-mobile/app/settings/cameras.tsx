      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.infoBanner}>
          <Text style={styles.infoText}>
            📹 Les caméras sont configurées par votre administrateur via le portail Aviora. Contactez-le pour ajouter ou modifier une caméra.
          </Text>
        </View>
        ...
        {!isLoading && !error && cameras.length === 0 && (
          <View style={styles.emptyBox}>
            ...
            <Text style={styles.emptySub}>
              Demandez à votre administrateur d'ajouter vos caméras via le portail web Aviora.
            </Text>
          </View>
        )}
