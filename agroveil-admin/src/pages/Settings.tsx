...
import { Settings as SettingsIcon, Bell, Shield, Globe, Key, Save, Eye, EyeOff, CreditCard, CheckCircle, XCircle } from 'lucide-react';
...
const TABS: { id: Tab; icon: React.ElementType; label: string }[] = [
  ...
  { id: 'whatsapp',      icon: Globe,        label: 'WhatsApp & SMS' },
      ...
      <div className="bg-white rounded-card border border-[#E8E8E8] shadow-card p-6">
        ...
        <div className="space-y-4">
          <ToggleRow
            ...
            sub="En dessous de ce seuil, l'alerte est ignorée"
            right={
          ...
          />
          <ToggleRow
            label="Alertes automatiques WhatsApp"
            sub="Envoyer automatiquement pour les alertes critiques"
  ...
  return (
    <div className="bg-white rounded-card border border-[#E8E8E8] shadow-card p-6">
      ...
      <div className="mt-6 border-t border-[#E8E8E8] pt-5">
        ...
        <input
          type="email"
          defaultValue="admin@agroveil.com"
          className="w-full border border-[#E8E8E8] rounded-btn px-3 py-2.5 text-sm text-[#1A1A1A] focus:outline-none focus:ring-2 focus:ring-[#1E6B2E]/30 focus:border-[#1E6B2E]"
        />
      </div>
      <div className="mt-5 flex justify-end">
    ...
    <div className="bg-white rounded-card border border-[#E8E8E8] shadow-card p-6">
      ...
      <div className="space-y-4">
        ...
        <Field label="Template ID (alertes critiques)">
          <input type="text" defaultValue="agroveil_critical_alert" className={inp} />
        </Field>
      </div>
...
const PAYMENT_PROVIDERS: PaymentProvider[] = [
  {
    ...
    fields: [
      ...
      { key: 'callback_url',   label: 'Callback URL',      placeholder: 'https://api.agroveil.com/webhooks/mtn' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'callback_url',   label: 'Callback URL',      placeholder: 'https://api.agroveil.com/webhooks/orange' },
    ],
  },
  {
    id: 'airtel_money',
    ...
    fields: [
      ...
      { key: 'callback_url',   label: 'Callback URL',      placeholder: 'https://api.agroveil.com/webhooks/airtel' },
    ],
  },
  {
    id: 'stripe',
...
function TabAPI({ onSave }: { onSave: () => void }) {
  ...
  return (
    <div className="bg-white rounded-card border border-[#E8E8E8] shadow-card p-6">
      ...
      <p className="text-xs text-[#888888] mb-5">Utilisez ces clés pour connecter des services tiers à AgroVeil.</p>
      ...
      <div className="space-y-4">
        ...
        <div className="border-t border-[#E8E8E8] pt-4">
          ...
          <input type="url" placeholder="https://votre-serveur.com/webhook/agroveil" className={inp} />
          <p className="text-[11px] text-[#888888] mt-1.5">
            AgroVeil enverra un POST JSON à cette URL pour chaque nouvelle alerte.
          </p>
        </div>
