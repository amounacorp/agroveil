...
const MENU_ITEMS = [
  { icon: '🔔', label: 'Notifications',   sub: 'Alertes WhatsApp et push',     route: '/settings/notifications' },
  { icon: '📹', label: 'Caméras',          sub: 'Configurer vos appareils',      route: '/settings/cameras'       },
  { icon: '🤖', label: 'Paramètres IA',   sub: 'Seuils de détection',           route: '/settings/ai-params'     },
  { icon: '📡', label: 'Synchronisation', sub: 'Mode hors-ligne et sync',       route: '/settings/sync'          },
  { icon: '❓', label: 'Aide',             sub: "Guide d'utilisation",           route: '/settings/help'          },
];
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.version}>AgroVeil v1.0.0{user ? ` · ${user.id}` : ' · Mode démo'}</Text>
