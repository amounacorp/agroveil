...
const FAQ = [
  {
    ...
    a: "Les caméras sont configurées par votre administrateur via le portail web AgroVeil. Contactez votre gestionnaire de ferme ou l'équipe AgroVeil.",
  },
  {
  ...
  },
  {
    ...
    a: "Utilisez le portail web AgroVeil ou l'option 'Créer un compte' sur l'écran de connexion de l'application mobile.",
  },
  {
    q: "Comment modifier mon mot de passe ?",
    a: "La modification du mot de passe n'est pas encore disponible dans l'app. Contactez le support AgroVeil pour un reset.",
  },
];
    ...
    <SafeAreaView style={styles.safe} edges={['bottom']}>
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.hero}>
          ...
          <Text style={styles.heroSub}>AgroVeil — Surveillance avicole intelligente</Text>
        </View>
        ...
        <View style={styles.card}>
          <ContactRow icon="📧" label="Support email" value="support@agroveil.com" onPress={() => Linking.openURL('mailto:support@agroveil.com')} />
          <View style={styles.divider} />
          <ContactRow icon="💬" label="WhatsApp Support" value="+242 06 XXX XXXX" onPress={() => Linking.openURL('https://wa.me/242060000000')} />
          <View style={styles.divider} />
          <ContactRow icon="🌐" label="Site web" value="agroveil.com" onPress={() => Linking.openURL('https://agroveil.com')} />
        </View>

        {/* Version */}
        <View style={styles.versionBox}>
          <Text style={styles.versionText}>AgroVeil Mobile v1.0.0</Text>
          <Text style={styles.versionSub}>© 2026 AgroVeil. Tous droits réservés.</Text>
        </View>
